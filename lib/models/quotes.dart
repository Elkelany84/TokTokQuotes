...
List<String> quotes = [
  ...
  'كارف العيشة وشادد الفيشة',
  'كل عيد والأندال بعيد',
  'حاول أن توصل لمستوايا أولا ثم فكر فى منافستى',
  'الصاحب الرخيص لا له فحص ولا ترخيص',
  'العز مش فى الفلوس العز فى النفوس',
  'بينما نحن ننتظر أن يمر الصعب مر العمر',
  'محدش بيراعى غير لبن المراعى',
  'ريح عشان الجو مريح',
  'لو يعلم الحب كم أحببتك لتمنى الحب أن يكون حبيبي'
];
